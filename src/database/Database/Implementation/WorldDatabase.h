...
enum WorldDatabaseStatements : uint32
{
    ...
    */
    ...
    WORLD_SEL_CREATURES_ALL,
    WORLD_SEL_CREATURES_WITH_MAP,
    WORLD_SEL_CREATURES_NAME,

    WORLD_SEL_GAMEOBJECTS_ALL,
    WORLD_SEL_GAMEOBJECTS_WITH_MAP,
    WORLD_SEL_GAMEOBJECTS_NAME,
